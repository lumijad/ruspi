...
pub fn get_websocket_filters() -> impl Filter<Extract=impl warp::Reply, Error=warp::Rejection> + Clone {
    ...
    let chat = warp::path!("websocket" / "chat")
    ...
    let echo = warp::path!("websocket" / "echo")
